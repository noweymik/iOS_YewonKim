...
class ComingSoonTableViewCell: UITableViewCell {
    ...
    func setUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            movie_image.heightAnchor.constraint(equalToConstant: 200),
            movie_image.widthAnchor.constraint(equalTo: contentView.widthAnchor),
            
            remindme_button.topAnchor.constraint(equalTo: movie_image.bottomAnchor, constant: 10),
            remindme_button.leadingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -175),
            
            share_button.topAnchor.constraint(equalTo: movie_image.bottomAnchor, constant: 10),
            share_button.leadingAnchor.constraint(equalTo: remindme_button.trailingAnchor, constant: 25),
            
            releaseDate_label.topAnchor.constraint(equalTo: movie_image.bottomAnchor, constant: 75),
